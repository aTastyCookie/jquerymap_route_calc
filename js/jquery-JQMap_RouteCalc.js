...
////////////////////////// END GOOGLE MAP API /////////////////
 ...
 $.fn.JQMap = function(options) {
            ...
            jqm_WpExtra          :  'You can use only 20 destinations plus start and destination, form more destination you nedd a business account',//--> text for wp excess
...
//--------------------------------------------------------------------------////---------------------------------------------------------//
          /************** create map, form to calc route and info panel *********************/
               ...
               $add_destination.click(function(){
                 if ($destination.find("input").length >= 20){ alert(o.jqm_WpExtra); return false;};
